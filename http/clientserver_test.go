...
import (
	...
	"github.com/studyzy/gmnet/http/httputil"
	"net/url"
	"os"
	"reflect"
	"runtime"
...
func testWriteHeaderAfterWrite(t *testing.T, h2, hijack bool) {
	...
	wantLog := "http: superfluous response.WriteHeader call from github.com/studyzy/gmnet/http_test.testWriteHeaderAfterWrite.func1 (clientserver_test.go:"
	if hijack {
		wantLog = "http: response.WriteHeader on hijacked connection from github.com/studyzy/gmnet/http_test.testWriteHeaderAfterWrite.func1 (clientserver_test.go:"
	}
